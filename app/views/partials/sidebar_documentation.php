            ...
            <div id="sidebar_left" class="sidebars">
                <menu class="desktop">
                    <li><a href="/documentation">API Introduction</a></li>
                    <li><a href="/documentation/authentication">Authentication</a></li>
                    <li><a href="/documentation/request">Request</a></li>
 ...
 */ ?>
                ...
                <menu class="mobile">
                    <li><a href="/documentation#content">API Introduction</a></li>
                    <li><a href="/documentation/authentication#content">Authentication</a></li>
                    <li><a href="/documentation/request#content">Request</a></li>
                    <li><a href="/documentation/response#content">Response</a></li>
                    <li><a href="/documentation/sandbox#content">Sandbox</a></li>
                    <li><a href="/documentation/client#content">Client</a></li>
                    <li><a href="/documentation/cli#content">CLI</a></li>
                    <li><a href="/documentation/changelog#content">Changelog</a></li>
                    <li>
                        <a href="/documentation/endpoints#content">Endpoints</a>
                        <menu>
